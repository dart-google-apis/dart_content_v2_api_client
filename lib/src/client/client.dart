...
abstract class Client extends ClientBase {
  core.String basePath = "/content/v2/";
  ...
  AccountstatusesResource_ get accountstatuses => new AccountstatusesResource_(this);
  DatafeedsResource_ get datafeeds => new DatafeedsResource_(this);
  DatafeedstatusesResource_ get datafeedstatuses => new DatafeedstatusesResource_(this);
  InventoryResource_ get inventory => new InventoryResource_(this);
  ProductsResource_ get products => new ProductsResource_(this);
  ProductstatusesResource_ get productstatuses => new ProductstatusesResource_(this);
